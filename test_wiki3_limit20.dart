...
Future<void> main() async {
  ...
  for (final uni in unis) {
    ...
    final url = 'https://en.wikipedia.org/w/api.php?action=query&redirects=1&generator=images&titles=$encodedQuery&gimlimit=20&prop=imageinfo&iiprop=url&format=json';
