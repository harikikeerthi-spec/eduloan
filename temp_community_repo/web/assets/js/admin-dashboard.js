...
async function viewApplication(id) {
    try {
        ...
        if (response.ok) {
            ...
            document.getElementById('modalAppId').value = app.id || app.applicationId;
            document.getElementById('modalAppStage').value = app.stage || app.currentStage || 'application_submitted';
            document.getElementById('modalAppStatus').value = app.status || 'pending';
            document.getElementById('modalAppRemarks').value = ''; // Reset notes

            // Render Applicant Info
            const applicantInfo = `
                <div class="col-span-2 sm:col-span-1">
                    <span class="block text-gray-500 mb-1">Full Name</span>
                    <strong class="text-gray-900 dark:text-white">${escapeHtml(app.firstName || '')} ${escapeHtml(app.lastName || '')}</strong>
                </div>
                <div class="col-span-2 sm:col-span-1">
                    <span class="block text-gray-500 mb-1">Email</span>
                    <strong class="text-gray-900 dark:text-white">${escapeHtml(app.email || 'N/A')}</strong>
                </div>
                <div class="col-span-2 sm:col-span-1">
                    <span class="block text-gray-500 mb-1">Phone Number</span>
                    <strong class="text-gray-900 dark:text-white">${escapeHtml(app.phoneNumber || 'N/A')}</strong>
                </div>
                <div class="col-span-2 sm:col-span-1">
                    <span class="block text-gray-500 mb-1">Application Date</span>
                    <strong class="text-gray-900 dark:text-white">${new Date(app.createdAt || app.submittedAt || new Date()).toLocaleDateString()}</strong>
                </div>
            `;
            document.getElementById('modalApplicantInfo').innerHTML = applicantInfo;

            // Render Loan Info
            const loanInfo = `
                <div class="col-span-2 sm:col-span-1">
                    <span class="block text-gray-500 mb-1">Lending Partner (Bank)</span>
                    <strong class="text-gray-900 dark:text-white">${escapeHtml(app.bank || 'N/A')}</strong>
                </div>
                <div class="col-span-2 sm:col-span-1">
                    <span class="block text-gray-500 mb-1">Loan Amount</span>
                    <strong class="text-gray-900 dark:text-white">₹${(app.amount || 0).toLocaleString()}</strong>
                </div>
                <div class="col-span-2 sm:col-span-1">
                    <span class="block text-gray-500 mb-1">University</span>
                    <strong class="text-gray-900 dark:text-white">${escapeHtml(app.universityName || 'N/A')}</strong>
                </div>
                <div class="col-span-2 sm:col-span-1">
                    <span class="block text-gray-500 mb-1">Course</span>
                    <strong class="text-gray-900 dark:text-white">${escapeHtml(app.courseName || 'N/A')}</strong>
                </div>
            `;
            document.getElementById('modalLoanInfo').innerHTML = loanInfo;
...
async function handleUpdateApplication(e) {
    ...
    const stage = document.getElementById('modalAppStage').value;
    const status = document.getElementById('modalAppStatus').value;
    const remarks = document.getElementById('modalAppRemarks').value;
...
window.handleUpdateApplication = handleUpdateApplication;
