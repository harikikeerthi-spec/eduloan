...
<p>Education loans are an investment in your future. With proper planning and understanding, you can navigate the process smoothly and focus on what matters most - your education.</p>
    `,
        ...
        authorImage: 'http://10.0.2.2:3000/images/blog1.png',
        featuredImage: 'http://10.0.2.2:3000/images/blog1.png',
        readTime: 8,
        isFeatured: true,
        isPublished: true,
...
<p>Each country offers unique advantages. Consider your academic goals, budget, and career aspirations when making your decision.</p>
    `,
        ...
        authorImage: 'http://10.0.2.2:3000/images/blog2.png',
        featuredImage: 'http://10.0.2.2:3000/images/blog2.png',
        readTime: 10,
        isFeatured: true,
        isPublished: true,
...
<p>Financial planning is key to a successful study abroad experience. Start early and track your expenses regularly.</p>
    `,
        ...
        authorImage: 'http://10.0.2.2:3000/images/blog3.png',
        featuredImage: 'http://10.0.2.2:3000/images/blog3.png',
        readTime: 6,
        isFeatured: false,
        isPublished: true,
...
<li>Stay persistent and positive</li>
    ...
    `,
        ...
        authorImage: 'http://10.0.2.2:3000/images/blog4.png',
        featuredImage: 'http://10.0.2.2:3000/images/blog4.png',
        readTime: 4,
        isFeatured: false,
        isPublished: true,
...
<li>Consider loan refinancing if rates drop significantly</li>
    ...
    `,
        ...
        authorImage: 'http://10.0.2.2:3000/images/blog5.png',
        featuredImage: 'http://10.0.2.2:3000/images/blog5.png',
        readTime: 9,
        isFeatured: true,
        isPublished: true,
...
<p>Proper documentation and preparation are key to a successful visa application. Plan ahead and stay organized.</p>
    `,
        ...
        authorRole: 'Immigration Specialist',
        authorImage: 'http://10.0.2.2:3000/images/blog6.png',
        featuredImage: 'http://10.0.2.2:3000/images/blog6.png',
        readTime: 7,
        isFeatured: false,
        isPublished: true,
...
async function main() {
    ...
    for (const blog of sampleBlogs) {
        ...
        if (!existing) {
            ...
            // Update existing placeholder blogs with premium content
