...
async function main() {
    ...
    await prisma.country.createMany({
        data: [
            ...
            },
            {
                ...
                popularForStudy: true,
                universities: 1000,
                averageTuitionFee: '₹50,000-₹5,00,000/year',
                averageLivingCost: '₹1,20,000-₹3,00,000/year',
                studyDuration: '3-4 years for Bachelors, 2 years for Masters',
                visaType: 'Student Visa',
                visaProcessingTime: '2-4 weeks',
                workPermit: true,
                postStudyWorkVisa: 'N/A',
                popularCities: ['Mumbai', 'Delhi', 'Bangalore', 'Chennai', 'Hyderabad'],
                currency: 'INR',
                language: ['Hindi', 'English'],
                flagUrl: 'https://flagcdn.com/w320/in.png',
                description: 'India is home to some of the world\'s most competitive technical institutes and diverse educational landscape.',
            },
        ],
        skipDuplicates: true,
    });
    ...
    await prisma.university.createMany({
        data: [
            ...
            },
            {
                ...
                description: 'IIT Bombay is a premier technical and research university in India, known for its engineering and science programs.',
                popularCourses: ['Engineering', 'Computer Science', 'Design', 'Management'],
                averageFees: '₹2,00,000-₹4,00,000/year',
                acceptanceRate: 1.0,
                scholarships: true,
                isFeatured: true,
            },
            {
                ...
                description: 'IIT Delhi is a world-class institution known for its excellence in engineering, technology, and research.',
                popularCourses: ['Engineering', 'Computer Science', 'Textile Technology', 'Management'],
                averageFees: '₹2,00,000-₹4,00,000/year',
                acceptanceRate: 1.0,
                scholarships: true,
                isFeatured: true,
            },
            {
                ...
                popularCourses: ['Economics', 'Commerce', 'Physics', 'History'],
                averageFees: '₹10,000-₹50,000/year',
                acceptanceRate: 5.0,
                scholarships: true,
                isFeatured: true,
            },
            {
                ...
                description: 'Birla Institute of Technology & Science, Pilani is a leading private deemed university in India.',
                popularCourses: ['Engineering', 'Pharmacy', 'Management', 'Economics'],
                averageFees: '₹4,00,000-₹6,00,000/year',
                acceptanceRate: 2.0,
                scholarships: true,
                isFeatured: true,
            },
            {
                ...
                description: 'A constituent institute of Manipal Academy of Higher Education, known for its engineering programs.',
                popularCourses: ['Engineering', 'Computer Science', 'Information Technology'],
                averageFees: '₹3,00,000-₹5,00,000/year',
                acceptanceRate: 10.0,
                scholarships: true,
                isFeatured: true,
            },
            {
                ...
                description: 'IIT Kanpur is a premier research institute known for its science and engineering programs.',
                popularCourses: ['Aerospace Engineering', 'Computer Science', 'Physics'],
                averageFees: '₹2,00,000-₹4,00,000/year',
                acceptanceRate: 1.0,
                scholarships: true,
                isFeatured: true,
            },
            {
                ...
                description: 'The first IIT to be established, known for its vast campus and diverse academic programs.',
                popularCourses: ['Engineering', 'Architecture', 'Law', 'Management'],
                averageFees: '₹2,00,000-₹4,00,000/year',
                acceptanceRate: 1.0,
                scholarships: true,
                isFeatured: true,
            },
            {
                ...
                description: 'A premier technical university in South India.',
                popularCourses: ['Engineering', 'Architecture', 'Planning'],
                averageFees: '₹50,000-₹1,00,000/year',
                acceptanceRate: 15.0,
                scholarships: true,
                isFeatured: false,
            },
            {
                ...
                description: 'A leading private technical university in India.',
            ...
            },
            {
                ...
                description: 'A top-ranked private university in India.',
                popularCourses: ['Engineering', 'Medicine', 'Management'],
                averageFees: '₹2,50,000-₹4,50,000/year',
                acceptanceRate: 12.0,
                scholarships: true,
                isFeatured: false,
            },
            {
                ...
                description: 'A large private research university with multiple campuses.',
                popularCourses: ['Law', 'Business', 'Engineering', 'Psychology'],
                averageFees: '₹3,00,000-₹5,00,000/year',
                acceptanceRate: 20.0,
                scholarships: true,
                isFeatured: false,
    ...
    console.log(`- Loan Types: ${counts[0]} records`);
    console.log(`- Banks: ${counts[1]} records`);
    console.log(`- Countries: ${counts[2]} records`);
    console.log(`- Universities: ${counts[3]} records`);
    console.log(`- Scholarships: ${counts[4]} records`);
    console.log(`- Courses: ${counts[5]} records`);
