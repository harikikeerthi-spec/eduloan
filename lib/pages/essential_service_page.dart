...
class EssentialServicePage extends StatefulWidget {
  ...
  @override
  State<EssentialServicePage> createState() => _EssentialServicePageState();
}

class _EssentialServicePageState extends State<EssentialServicePage>
  ...
  Future<void> _loadSavedNotificationPref() async {
    ...
    final savedEmail = prefs.getString('${widget.serviceKey}_notify_email');
    final userEmail = prefs.getString('user_email') ?? '';
    final isNotified = prefs.getBool('${widget.serviceKey}_notified') ?? false;
  ...
  Future<void> _handleNotifyMe() async {
    ...
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('${widget.serviceKey}_notify_email', email);
    await prefs.setBool('${widget.serviceKey}_notified', true);
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      '${widget.serviceTitle} service is currently locked. Reserve your Gmail for early launch access!',
                                      style: GoogleFonts.outfit(
                                        fontSize: 13,
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    'Enter your Gmail address to get notified directly on your inbox when ${widget.serviceTitle} launches.',
                                    textAlign: TextAlign.center,
