...
class UniversityComparePage extends StatelessWidget {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Compare top universities across the globe to find your perfect fit.',
                        style: TextStyle(
                          fontSize: 16,
  ...
  Widget _buildFeaturePlaceholder() {
    return Container(
      ...
      child: Column(
        children: [
          const Icon(Icons.compare_arrows, size: 64, color: Color(0xFF311B92)),
          ...
          const SizedBox(height: 12),
          Text(
            'Our comparison engine is being tuned to give you the most accurate data.',
