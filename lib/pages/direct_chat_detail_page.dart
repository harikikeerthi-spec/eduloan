  ...
  void _sendMessage([String? quickText]) async {
    ...
    if (containsPhone && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text(
            'Phone numbers are masked to protect member privacy.',
          ),
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            if (_showPhoneAlertBanner ||
                _messages.any(
                  (m) => RegExp(r'XXXXXXXXXX').hasMatch(m.displayText),
                ))
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () =>
                          setState(() => _showPhoneAlertBanner = false),
                      child: const Icon(
                        Icons.close_rounded,
                        size: 18,
            ...
            Container(
              ...
              child: ListView(
                ...
                children: [
                  _buildQuickChip(
                    '📱 Share contact: 9876543210 (Test Masking)',
                  ),
